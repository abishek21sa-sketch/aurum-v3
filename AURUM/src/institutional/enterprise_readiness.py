...
REQUIRED_ARTIFACTS = (
    ...
    "src/institutional/public_data.py",
    ...
    "artifacts/public_data/sec_companyfacts_CIK0000789019.json",
    "artifacts/public_data/sec_companyfacts_CIK0000019617.json",
    "artifacts/public_data/sec_companyfacts_CIK0000070858.json",
    "artifacts/public_data/fdic_institutions.json",
    "artifacts/public_data/treasury_debt_to_penny.json",
    "artifacts/public_data/market_prices.csv",
    "artifacts/public_data/public_market_validation.json",
    ...
    "schemas/aurum_public_data_manifest.schema.json",
