...
class HRPBacktest:
    def __init__(
        ...
        weights_path="data/optimization/hrp_weights.csv",
        output_path="data/backtesting/hrp_backtest.csv",
        summary_path="data/backtesting/hrp_backtest_summary.csv",
