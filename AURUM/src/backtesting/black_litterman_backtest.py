...
class BlackLittermanBacktest:
    def __init__(
        self,
        returns_path="data/market_matrix/market_return_matrix.csv",
        weights_path="data/optimization/black_litterman_weights.csv",
        output_path="data/backtesting/black_litterman_backtest.csv",
        summary_path="data/backtesting/black_litterman_backtest_summary.csv",
    ...
    def run(self):
        ...
        print("BLACK LITTERMAN BACKTEST COMPLETE")
        print("=" * 60)
