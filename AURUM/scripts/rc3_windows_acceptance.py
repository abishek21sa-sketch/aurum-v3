...
def main():
    ...
    for script in ['mars_cvar_governance_evidence.py','mars_cvar_walk_forward_evidence.py','run_mars_cvar_institutional.py','run_deployment_preflight.py']:
    ...
    run(py,'-m','py_compile','src/optimization/signature_algorithm.py','src/institutional/mars_cvar_decision_bridge.py','src/institutional/mars_cvar_product.py','src/institutional/enterprise_readiness.py','src/institutional/deployment_preflight.py','src/institutional/ai_intelligence.py','src/institutional/live_data_contract.py','src/institutional/live_data_ingestion.py','src/institutional/model_validation.py','src/institutional/enterprise_platform.py','src/institutional/ai_evaluation.py','src/institutional/control_plane.py','src/institutional/operations_contract.py','src/api/main.py','scripts/product_adapter.py','scripts/product_runtime.py','scripts/product_frontend.py','scripts/run_deployment_preflight.py','scripts/verify_enterprise_release.py','scripts/export_enterprise_evidence.py','scripts/generate_sbom.py','dashboard/official_dashboard.py',env=env)
