...
cd /d "%~dp0"
echo ============================================================
echo AURUM_MARS_CVaR_RC3_PATCH1_PY314 - Python 3.14 Windows Acceptance
echo ============================================================
...
echo.
echo ============================================================
echo RC3 PATCH1 WINDOWS ACCEPTANCE PASSED
echo ============================================================
exit /b 0
...
echo.
echo ============================================================
echo RC3 PATCH1 WINDOWS ACCEPTANCE FAILED - exit code %ERRORLEVEL%
